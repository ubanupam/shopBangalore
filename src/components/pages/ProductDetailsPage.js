      ...
      <rect width="20" height="18" fill="white"/>
                ...
                <aside className="w-full lg:w-1/4 xl:w-1/4 xs:w-full pt-20 relative">
                    ...
                    <div className="bg-white itemPriceBox sticky top-0">
                        ...
                        <p className="pt-1 pb-2">Lurex Linen Viscose Jacket in Conchiglia</p>
                        ...
                        <div className="variants flex justify-items-start mb-6">
                                        <img src={variantImage1} className="object-none h-12 w-14" alt="first 1" loading="lazy" />
                                        <img src={variantImage2} className="object-none h-12 w-14" alt="scrollable 2" loading="lazy" />
                        </div>
                        ...
                        <div className="sizeBox size">
                            ...
                            <div className="flex justify-between items-center">
                                <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-8 border border-gray-400 rounded-full">
                                    XS
                                </button>
                                <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-8 border border-gray-400 rounded-full">
                                    S
                                ...
                                <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-8 border border-gray-400 rounded-full relative naColor">M
                                    <cite className="sizeNotAvailable naColor"></cite>
                                </button>
                                <button className="py-1 px-8 bg-black text-white hover:bg-gray-400 border border-gray-400 rounded-full">
                                    L
                                </button>
                            </div>
                            <div className="flex">
                                <button className="bg-white mt-2 hover:bg-gray-100 text-gray-800 font-semibold py-1 px-8 border border-gray-400 rounded-full">
                                    XXL
                                </button>
                            </div>
                        </div>
